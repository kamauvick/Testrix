...
async function main() {
    try {
        ...
        if (!config.userId) {
            throw new Error('userId is required in config.json');
        }

        if (!config.projectName) {
            throw new Error('projectName is required in config.json');
        }

        if (!config.reportsDir) {
            throw new Error('reportsDir is required in config.json');
        }
